...
export default function DiscCard(data) {
    ...
    return (
        ...
        <div className="bg-gray-50 text-black mr-8 rounded-md shadow-sm p-8 hover:shadow-md hover:text-white hover:bg-blue-800 origin-left transition all 1.0s ease">
